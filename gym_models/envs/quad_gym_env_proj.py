...
class QuadDynamicsProj(gym.Env):
    ...
    def __init__(self,
        ...
        super(QuadDynamicsProj, self).__init__()
    ...
    def step_dynamics(self, u):
        """
        Updates x, xdot, theta and thetadot.
        ----------
        state : dict 
        ----------
        control input u - (angular velocity)^2 of each rotors (rad^2/s^2)
        """
    ...
    def compute_h(self, observation, obstacles):
    ...
    def compute_A(self, observation, obstacles):
        A = np.empty((0, 2))
        for i in range(obstacles.shape[1]):
    ...
    def cbf(self, mod_obs):  # cbf with output constant control set
        # control in R^2
        ...
        if flag_none==0:    
            ...
            #except AssertionError as msg:
                ...
                try:
                    ...
                    # Initial values as (0,0) not rendering the otpimzation feasible
